...
/** \file
 *  \brief Board specific information header for the GH60 keyboard.
 *  \copydetails Group_BoardInfo_GH60
 *
 ...
 *  \defgroup Group_BoardInfo_GH60 GH60
 *  \brief Board specific information header for the GH60 keyboard.
 *
 *  @{
 */

#ifndef __BOARD_GH60_H__
#define __BOARD_GH60_H__
