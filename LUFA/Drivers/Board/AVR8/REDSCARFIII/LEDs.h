...
/** \file
 *  \brief Board specific LED driver header for the Red Scarf III keyboard.
 *  \copydetails Group_LEDs_REDSCARFIII
 *
...
/** \ingroup Group_LEDs
 *  \defgroup Group_LEDs_REDSCARFIII REDSCARFIII
 *  \brief Board specific LED driver header for the Red Scarf III keyboard.
 *
 *  @{
 */

#ifndef __LEDS_REDSCARFIII_H__
#define __LEDS_REDSCARFIII_H__
	...
	/* Private Interface - For use in library only: */
		...
		/* Macros: */
			...
			#define LEDS_PORTE_LEDS       (LEDS_LED2)
	#endif
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Inline Functions: */
			...
			{
				return ((~PORTC & LEDS_PORTC_LEDS) | (~PORTE & LEDS_PORTE_LEDS));
			}
		#endif
