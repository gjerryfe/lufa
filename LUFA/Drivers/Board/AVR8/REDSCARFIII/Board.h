...
/** \file
 *  \brief Board specific information header for the Red Scarf III keyboard.
 *  \copydetails Group_BoardInfo_REDSCARFIII
 *
 ...
 *  \defgroup Group_BoardInfo_REDSCARFIII REDSCARFIII
 *  \brief Board specific information header for the Red Scarf III keyboard.
 *
 *  @{
 */

#ifndef __BOARD_REDSCARFIII_H__
#define __BOARD_REDSCARFIII_H__
